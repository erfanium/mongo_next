...
import type { ConnectionPool, ConnectionPoolOptions } from "./connection.ts";
 ...
 * @category Event
 */
export class ConnectionCheckOutStartedEvent
 ...
 * @category Event
 */
export class ConnectionCheckOutFailedEvent
  extends ConnectionPoolMonitoringEvent {
