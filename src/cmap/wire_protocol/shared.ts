...
export function applyCommonQueryOptions(
  ...
  Object.assign(queryOptions, {
    ...
    promoteBuffers: typeof options.promoteBuffers === "boolean"
      ...
      : false,
    bsonRegExp: typeof options.bsonRegExp === "boolean"
      ? options.bsonRegExp
      : false,
    enableUtf8Validation: typeof options.enableUtf8Validation === "boolean"
...
export function isSharded(
  ...
  if (
    ...
    const servers: ServerDescription[] = Array.from(
      topologyOrServer.description.servers.values(),
    );
    return servers.some((server: ServerDescription) =>
      server.type === ServerType.Mongos
    );
  }
